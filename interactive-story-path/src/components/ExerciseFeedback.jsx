        ...
        <>
            <div className="row">
                <div className="col-12">
                    ...
                    <p>
                        By: {answer.username} {`(${answer.email})`}
                    </p>
                </div>
            </div>
            ...
            <div className="row">
                ...
                <div className="col-6">
                    <p>
                        <b>{feedbackA.correct ? 'Choice A is Correct!' : 'Choice A is incorrect!'}</b>
                    </p>
                ...
                <div className="col-6">
                    <p>
                        <b>{feedbackB.correct ? 'Choice B is Correct!' : 'Choice B is incorrect!'}</b>
                    </p>
